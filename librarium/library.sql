...
CREATE TABLE `book` (
  ...
  /*`status` tinyint(1) DEFAULT NULL COMMENT '是否借阅（已借阅1，未借阅0）',
...
CREATE TABLE `ordered` (
  ...
  /*`status` tinyint(1) DEFAULT NULL COMMENT '是否归还（未归还0，已归还1）',*/
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  KEY `bid` (`bid`)
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8;
...
(97,25,70,'2020年5月14日  22:23:3','2020年8月14日  22:23:3'),
(98,25,64,'2020年5月14日  22:23:5','2020年8月14日  22:23:5'),
...
(107,1,2,'2020年5月15日  1:9:51','2020年8月15日  1:9:51'),
(109,1,70,'2020年5月30日  11:28:19','2020年8月30日  11:28:19'),
(110,1,63,'2020年5月30日  12:5:54','2020年8月30日  12:5:54');
...
CREATE TABLE `returned` (
  ...
  /*`status` tinyint(1) DEFAULT NULL COMMENT '是否逾期（未逾期0，逾期1）',*/
  PRIMARY KEY (`id`)
...
(13,2,32,'2020年3月14  13:58:58','2020年5月14  21:58:58'),
(14,3,70,'2020年6月14  21:59:1','2020年5月14  21:59:1'),
(15,3,69,'2020年5月16  21:59:3','2020年5月14  21:59:3'),
(16,25,70,'2020年5月13  11:59:6','2020年5月14  21:59:6'),
(17,25,69,'2020年5月15  21:59:8','2020年5月14  21:59:8'),
(18,1,70,'2020年4月14  22:18:43','2020年5月14  22:18:43'),
(19,1,63,'2020年5月31  22:14:39','2020年5月29  22:14:39'),
(20,1,70,'2020年5月30  10:28:8','2020年5月30  11:28:8'),
(21,1,64,'2020年5月29  12:6:41','2020年5月30  12:6:41'),
(22,2,32,'2020年5月30  12:18:15','2020年5月30  12:15:15');
